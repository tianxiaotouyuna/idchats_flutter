...
// ignore: constant_identifier_names
		...
		abstract class NftDetailPageRemoteDataSource {
		Future<Map> getUserInfo(GetInitParams params);
		}

		class NftDetailPageRemoteDataSourceImpl implements NftDetailPageRemoteDataSource {
		final http.Client client;

		NftDetailPageRemoteDataSourceImpl({required this.client});
