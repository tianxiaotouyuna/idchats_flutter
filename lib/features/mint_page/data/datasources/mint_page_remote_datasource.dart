...
// ignore: constant_identifier_names
		...
		abstract class MintPageRemoteDataSource {
		Future<Map> getUserInfo(GetInitParams params);
		}

		class MintPageRemoteDataSourceImpl implements MintPageRemoteDataSource {
		final http.Client client;

		MintPageRemoteDataSourceImpl({required this.client});
