...
// ignore: constant_identifier_names
		...
		abstract class MessagePageRemoteDataSource {
		Future<Map> getUserInfo(GetInitParams params);
		}

		class MessagePageRemoteDataSourceImpl implements MessagePageRemoteDataSource {
		final http.Client client;

		MessagePageRemoteDataSourceImpl({required this.client});
