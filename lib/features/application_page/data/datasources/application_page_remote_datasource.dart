...
// ignore: constant_identifier_names
		...
		abstract class ApplicationPageRemoteDataSource {
		Future<Map> getUserInfo(GetInitParams params);
		}

		class ApplicationPageRemoteDataSourceImpl implements ApplicationPageRemoteDataSource {
		final http.Client client;

		ApplicationPageRemoteDataSourceImpl({required this.client});
