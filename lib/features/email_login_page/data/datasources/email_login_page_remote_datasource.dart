...
// ignore: constant_identifier_names
		...
		abstract class EmailLoginPageRemoteDataSource {
		Future<Map> getUserInfo(GetInitParams params);
		}

		class EmailLoginPageRemoteDataSourceImpl implements EmailLoginPageRemoteDataSource {
		final http.Client client;

		EmailLoginPageRemoteDataSourceImpl({required this.client});
