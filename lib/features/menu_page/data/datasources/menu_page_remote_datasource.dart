...
// ignore: constant_identifier_names
		...
		abstract class MenuPageRemoteDataSource {
		Future<Map> getUserInfo(GetInitParams params);
		}

		class MenuPageRemoteDataSourceImpl implements MenuPageRemoteDataSource {
		final http.Client client;

		MenuPageRemoteDataSourceImpl({required this.client});
