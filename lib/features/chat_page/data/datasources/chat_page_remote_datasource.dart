...
// ignore: constant_identifier_names
		...
		abstract class ChatPageRemoteDataSource {
		Future<Map> getUserInfo(GetInitParams params);
		}

		class ChatPageRemoteDataSourceImpl implements ChatPageRemoteDataSource {
		final http.Client client;

		ChatPageRemoteDataSourceImpl({required this.client});
