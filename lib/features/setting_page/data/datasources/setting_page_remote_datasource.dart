...
// ignore: constant_identifier_names
		...
		abstract class SettingPageRemoteDataSource {
		Future<Map> getUserInfo(GetInitParams params);
		}

		class SettingPageRemoteDataSourceImpl implements SettingPageRemoteDataSource {
		final http.Client client;

		SettingPageRemoteDataSourceImpl({required this.client});
