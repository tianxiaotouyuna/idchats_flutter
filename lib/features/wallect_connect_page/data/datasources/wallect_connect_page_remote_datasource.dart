...
// ignore: constant_identifier_names
		...
		abstract class WallectConnectPageRemoteDataSource {
		Future<Map> getUserInfo(GetInitParams params);
		}

		class WallectConnectPageRemoteDataSourceImpl implements WallectConnectPageRemoteDataSource {
		final http.Client client;

		WallectConnectPageRemoteDataSourceImpl({required this.client});
