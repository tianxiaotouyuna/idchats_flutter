...
// ignore: constant_identifier_names
		...
		abstract class SpacePageRemoteDataSource {
		Future<Map> getUserInfo(GetInitParams params);
		}

		class SpacePageRemoteDataSourceImpl implements SpacePageRemoteDataSource {
		final http.Client client;

		SpacePageRemoteDataSourceImpl({required this.client});
